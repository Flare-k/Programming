...
private:
    ...
    BinarySearchTree<SimpleItemType> simple_List;//Song List
...
public:
    ...
    /*
     ...
     Song의 정렬은 Binary Search Tree로 정렬하였고, 기준은 ID로 하였습니다.
     */
    void SearchByID();
    /*
    ...
    void DeleteSong();
    /*
     DeleteSong() = 가수의 이름을 검색하여 존재하면 Binary Search Tree로 삭제해주는 함수.
     */
