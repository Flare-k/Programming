...
middle_data <- read.table("/Users/noblyan/Desktop/middle_data.txt", header=TRUE, sep=",")
...
# 3
```{r,error=T}
boston_housing <- read.csv("/Users/noblyan/Desktop/BostonHousing.csv",header=TRUE)
...
# 4
```{r,error=T}
laptopsale <- read.csv("/Users/noblyan/Desktop/LaptopSalesJanuary2008.csv", header=T, stringsAsFactors = F)
View(laptopsale)
